...
class TrainManager:
    ...
    def _train_batch(self, batch: Batch, update: bool = True) -> (Tensor, Tensor):
        ...
        if self.do_translation:
            ...
            #normalized_translation_loss = translation_loss/txt_normalization_factor
        else:
        ...
        #self.total_temp += normalized_recognition_loss + normalized_translation_loss
        # compute gradients
        #print('before',self.model.grad)
        total_loss.backward()
        
        #self.total_temp.backward()
